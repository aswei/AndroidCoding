package cn.com.coding.androidcodinglibrary;
...
import cn.com.coding.androidcodinglibrary.utils.base.PackageUtils;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public boolean handleException(Throwable ex) {
        ...
        new Thread() {
            public void run() {
                Looper.prepare();
                LogUtils.e(crashReport); // 打印异常信息，也可保存至文件 方便远程调试
                Looper.loop();
            }
